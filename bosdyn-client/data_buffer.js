...
class DataBufferClient extends BaseClient {
  ...
  _do_add_text_messages(func, text_messages, args) {
    ...
    return func(this._stub.recordTextMessages, request, null, common_header_errors, args);
  }
  ...
  _do_add_operator_comment(func, msg, robot_timestamp = null, args) {
    ...
    return func(this._stub.recordOperatorComments, request, null, common_header_errors, args);
  }

  add_blob(data, type_id, channel = null, robot_timestamp = null, write_sync = false, args) {
    return this._do_add_blob(this.call, data, type_id, channel, robot_timestamp, write_sync, args);
  }

  add_blob_async(data, type_id, channel = null, robot_timestamp = null, write_sync = false, args) {
    return this._do_add_blob(this.call_async, data, type_id, channel, robot_timestamp, write_sync, args);
  }

  _do_add_blob(func, data, type_id, channel, robot_timestamp, write_sync, args) {
    ...
    return func(this._stub.recordDataBlobs, request, null, common_header_errors, args);
  }

  add_protobuf(proto, channel = null, robot_timestamp = null, write_sync = false) {
    return this._do_add_protobuf(this.add_blob, proto, channel, robot_timestamp, write_sync);
  }

  add_protobuf_async(proto, channel = null, robot_timestamp = null, write_sync = false) {
    return this._do_add_protobuf(this.add_blob_async, proto, channel, robot_timestamp, write_sync);
  }

  _do_add_protobuf(func, proto, channel, robot_timestamp, write_sync) {
    ...
    return func(binary_data, type_id, channel, robot_timestamp, write_sync);
  }

  add_events(events, args) {
    return this._do_add_events(this.call, events, args);
  }

  add_events_async(events, args) {
    return this._do_add_events(this.call_async, events, args);
  }

  _do_add_events(func, events, args) {
    ...
    return func(this._stub.recordEvents, request, null, common_header_errors, args);
  }

  register_signal_schema(variables, schema_name, args) {
    return this._do_register_signal_schema(this.call, variables, schema_name, args);
  }

  register_signal_schema_async(variables, schema_name, args) {
    return this._do_register_signal_schema(this.call_async, variables, schema_name, args);
  }

  _do_register_signal_schema(func, variables, schema_name, args) {
    ...
    return func(this._stub.registerSignalSchema, request, value_from_response, common_header_errors, args);
  }
  ...
  add_signal_tick(
    ...
    return this._do_add_signal_tick(this.call, data, schema_id, encoding, sequence_id, source, args);
  }

  add_signal_tick_async(
    data,
    schema_id,
    encoding = data_buffer_protos.SignalTick.Encoding.ENCODING_RAW,
    sequence_id = 0,
    ...
    return this._do_add_signal_tick(this.call_async, data, schema_id, encoding, sequence_id, source, args);
  }

  _do_add_signal_tick(func, data, schema_id, encoding, sequence_id, source, args) {
    ...
    return func(this._stub.recordSignalTicks, request, null, common_header_errors, args);
  }
