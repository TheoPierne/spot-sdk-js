...
class DataServiceClient extends BaseClient {
  ...
  get_data_index(query, args) {
    return this._do_get_data_index(this.call, query, args);
  }
   ...
   * @private
   */
  _do_get_data_index(func, query, args) {
    const request = new data_index_protos.GetDataIndexRequest().setDataQuery(query);
    return func(this._stub.getDataIndex, request, null, common_header_errors, args);
  }
  ...
  get_data_pages(time_range, args) {
    return this._do_get_data_pages(this.call, time_range, args);
  }
   ...
   * @private
   */
  _do_get_data_pages(func, time_range, args) {
    const request = new data_index_protos.GetDataPagesRequest().setTimeRange(time_range);
    return func(this._stub.getDataPages, request, null, common_header_errors, args);
  }
  ...
  delete_data_pages(time_range, page_ids, args) {
    return this._do_delete_data_pages(this.call, time_range, page_ids, args);
  }
   ...
   * @private
   */
  _do_delete_data_pages(func, time_range, page_ids, args) {
    const request = new data_index_protos.DeleteDataPagesRequest().setTimeRange(time_range).setPageIdsList(page_ids);
    return func(this._stub.deleteDataPages, request, null, common_header_errors, args);
  }
  ...
  get_events_comments(query, args) {
    return this._do_get_events_comments(this.call, query, args);
  }
   ...
   * @private
   */
  _do_get_events_comments(func, query, args) {
    const request = new data_index_protos.GetEventsCommentsRequest().setEventCommentRequest(query);
    return func(this._stub.getEventsComments, request, null, common_header_errors, args);
  }
  ...
  get_data_buffer_status(get_blob_specs = false, args) {
    return this._do_get_data_buffer_status(this.call, get_blob_specs, args);
  }
   ...
   * @private
   */
  _do_get_data_buffer_status(func, get_blob_specs, args) {
    const request = new data_index_protos.GetDataBufferStatusRequest().setGetBlobSpecs(get_blob_specs);
    return func(this._stub.getDataBufferStatus, request, null, common_header_errors, args);
  }
}
