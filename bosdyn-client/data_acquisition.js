...
class DataAcquisitionClient extends BaseClient {
   ...
   * @param {number} request_id The request id associated with an AcquireData request.
   * @param {Object} [args] Extra arguments for controlling RPC details.
   * @returns {Promise<data_acquisition.GetStatusResponse>} If the RPC is successful, then it will return the
  ...
  get_service_info_async(args) {
    ...
    return this.call_async(
      this._stub.getServiceInfo,
      request,
      _get_service_info_capabilities,
