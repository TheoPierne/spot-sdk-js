...
class StreamQualityClient extends BaseClient {
  ...
  set_stream_params(target_bitrate = null, refresh_interval = null, idr_interval = null, awb_mode = null, args) {
    ...
    return this.call(
      ...
      request,
      this._params_from_response,
      this._streamquality_error_from_response,
      args,
    );
  }
