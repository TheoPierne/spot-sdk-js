...
class PowerClient extends BaseClient {
  ...
  get_power_status(args) {
    const request = new power_pb.GetPowerStatusRequest();
    return this.call(
      this._stub.getPowerStatus,
      request,
      this._get_power_status_from_response,
      this._power_error_from_response,
      args,
    );
  }
  ...
  set_power_status(ptz = null, aux1 = null, aux2 = null, args) {
    const request = this._build_SetPowerStatusRequest(ptz, aux1, aux2);
    return this.call(
      this._stub.setPowerStatus,
      request,
      this._set_power_status_from_response,
      this._power_error_from_response,
      args,
    );
  }
  ...
  cycle_power(ptz = null, aux1 = null, aux2 = null, external_mic = null, args) {
    const request = this._build_CyclePowerRequest(ptz, aux1, aux2, external_mic);
    return this.call(
      this._stub.CyclePower,
      request,
      this._cycle_power_from_response,
      this._power_error_from_response,
      args,
    );
  }
