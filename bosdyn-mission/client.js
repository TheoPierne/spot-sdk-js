...
const { BaseClient, common_header_errors, error_factory } = require('../bosdyn-client/common');
...
class ValidationError extends MissionResponseError {
  constructor(res, msg) {
    super(res, msg);
    this.failed_nodes = res.getFailedNodesList();
...
class MissionClient extends BaseClient {
  ...
  get_state(upper_tick_bound = null, lower_tick_bound = null, past_ticks = null, args) {
    const req = this._get_state_request(upper_tick_bound, lower_tick_bound, past_ticks);
    return this.call(this._stub.getState, req, _get_state_value, common_header_errors, args);
  }
  ...
  answer_question(question_id, code, args) {
    const req = this._answer_question_request(question_id, code);
    return this.call(this._stub.answerQuestion, req, null, _answer_question_error_from_response, args);
  }
  ...
  load_mission(root, leases, args) {
    const req = this._load_mission_request(root, leases);
    return this.call(this._stub.loadMission, req, null, _load_mission_error_from_response, args);
  }
  ...
  load_mission_as_chunks(root, leases, data_chunk_byte_size = 1_000 * 1_000, args) {
    const req = this._load_mission_request(root, leases);
    return this.call(
      this._stub.loadMissionAsChunks,
      BaseClient.chunk_message(req, data_chunk_byte_size),
      null,
      _load_mission_error_from_response,
      args,
    );
  }
  ...
  play_mission(pause_time_secs, leases, settings = null, args) {
    const req = this._play_mission_request(pause_time_secs, leases, settings);
    return this.call(this._stub.playMission, req, null, _play_mission_error_from_response, args);
  }
  ...
  restart_mission(pause_time_secs, leases, settings = null, args) {
    const req = this._restart_mission_request(pause_time_secs, leases, settings);
    return this.call(this._stub.restartMission, req, null, _restart_mission_error_from_response, args);
  }
  ...
  pause_mission(args) {
    ...
    return this.call(this._stub.pauseMission, req, null, _pause_mission_error_from_response, args);
  }
  ...
  stop_mission(args) {
    ...
    return this.call(this._stub.StopMission, req, null, _stop_mission_error_from_response, args);
  }
  ...
  get_info(args) {
    ...
    return this.call(this._stub.getInfo, req, _get_info_value, common_header_errors, args);
  }
  ...
  get_mission(args) {
    ...
    return this.call(this._stub.getMission, req, null, common_header_errors, args);
  }
...
const _ANSWER_QUESTION_STATUS_TO_ERROR = {
  ...
  [mission_pb.AnswerQuestionResponse.Status.STATUS_INVALID_QUESTION_ID]: [
    InvalidQuestionId,
    'The indicated question is unknown.',
  ],
  [mission_pb.AnswerQuestionResponse.Status.STATUS_INVALID_CODE]: [
    InvalidAnswerCode,
    'The indicated answer code is invalid for the specified question.',
  ],
  [mission_pb.AnswerQuestionResponse.Status.STATUS_ALREADY_ANSWERED]: [
...
function _answer_question_error_from_response(response) {
  return error_factory(
    response,
    response.getStatus(),
    Object.keys(mission_pb.AnswerQuestionResponse.Status),
...
function _load_mission_error_from_response(response) {
  return error_factory(
    response,
    response.getStatus(),
    Object.keys(mission_pb.LoadMissionResponse.Status),
...
function _play_mission_error_from_response(response) {
  return error_factory(
    response,
    response.getStatus(),
    Object.keys(mission_pb.PlayMissionResponse.Status),
...
function _pause_mission_error_from_response(response) {
  return error_factory(
    response,
    response.getStatus(),
    Object.keys(mission_pb.PauseMissionResponse.Status),
...
function _stop_mission_error_from_response(response) {
  return error_factory(
    response,
    response.getStatus(),
    Object.keys(mission_pb.StopMissionResponse.Status),
...
function _restart_mission_error_from_response(response) {
  return error_factory(
    response,
    response.getStatus(),
    Object.keys(mission_pb.RestartMissionResponse.Status),
