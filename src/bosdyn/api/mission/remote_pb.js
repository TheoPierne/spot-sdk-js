...
goog.exportSymbol('proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest', null, global);
goog.exportSymbol('proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse', null, global);
 ...
 * @constructor
 */
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest.displayName = 'proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse.displayName = 'proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse';
}
...
/**
 * optional bosdyn.api.DictParam params = 5;
 * @return {?proto.bosdyn.api.DictParam}
 */
proto.bosdyn.api.mission.TickRequest.prototype.getParams = function() {
  return /** @type{?proto.bosdyn.api.DictParam} */ (
    jspb.Message.getWrapperField(this, bosdyn_api_service_customization_pb.DictParam, 5));
};
 ...
 * @return {!proto.bosdyn.api.mission.TickRequest} returns this
*/
proto.bosdyn.api.mission.TickRequest.prototype.setParams = function(value) {
 ...
 * @return {!proto.bosdyn.api.mission.TickRequest} returns this
 */
proto.bosdyn.api.mission.TickRequest.prototype.clearParams = function() {
 ...
 * @return {boolean}
 */
proto.bosdyn.api.mission.TickRequest.prototype.hasParams = function() {
 ...
 * @return {string}
 */
proto.bosdyn.api.mission.TickRequest.prototype.getGroupName = function() {
 ...
 * @return {!proto.bosdyn.api.mission.TickRequest} returns this
 */
proto.bosdyn.api.mission.TickRequest.prototype.setGroupName = function(value) {
...
/**
 * optional bosdyn.api.CustomParamError custom_param_error = 9;
 * @return {?proto.bosdyn.api.CustomParamError}
 */
proto.bosdyn.api.mission.TickResponse.prototype.getCustomParamError = function() {
  return /** @type{?proto.bosdyn.api.CustomParamError} */ (
    jspb.Message.getWrapperField(this, bosdyn_api_service_customization_pb.CustomParamError, 9));
};
 ...
 * @return {!proto.bosdyn.api.mission.TickResponse} returns this
*/
proto.bosdyn.api.mission.TickResponse.prototype.setCustomParamError = function(value) {
 ...
 * @return {!proto.bosdyn.api.mission.TickResponse} returns this
 */
proto.bosdyn.api.mission.TickResponse.prototype.clearCustomParamError = function() {
 ...
 * @return {boolean}
 */
proto.bosdyn.api.mission.TickResponse.prototype.hasCustomParamError = function() {
 ...
 * @return {!Object}
 */
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest;
  return proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest}
 */
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getHeader();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.bosdyn.api.RequestHeader}
 */
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest.prototype.getHeader = function() {
  return /** @type{?proto.bosdyn.api.RequestHeader} */ (
    jspb.Message.getWrapperField(this, bosdyn_api_header_pb.RequestHeader, 1));
};
...
/**
 * @param {?proto.bosdyn.api.RequestHeader|undefined} value
 * @return {!proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest} returns this
*/
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest.prototype.setHeader = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest} returns this
 */
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest.prototype.clearHeader = function() {
  return this.setHeader(undefined);
};
 ...
 * @return {boolean}
 */
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoRequest.prototype.hasHeader = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!Object}
 */
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse;
  return proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse}
 */
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getHeader();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.bosdyn.api.ResponseHeader}
 */
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse.prototype.getHeader = function() {
  return /** @type{?proto.bosdyn.api.ResponseHeader} */ (
    jspb.Message.getWrapperField(this, bosdyn_api_header_pb.ResponseHeader, 1));
};
...
/**
 * @param {?proto.bosdyn.api.ResponseHeader|undefined} value
 * @return {!proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse} returns this
*/
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse.prototype.setHeader = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse} returns this
 */
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse.prototype.clearHeader = function() {
  return this.setHeader(undefined);
};
 ...
 * @return {boolean}
 */
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse.prototype.hasHeader = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional bosdyn.api.DictParam.Spec custom_params = 2;
 * @return {?proto.bosdyn.api.DictParam.Spec}
 */
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse.prototype.getCustomParams = function() {
  return /** @type{?proto.bosdyn.api.DictParam.Spec} */ (
    jspb.Message.getWrapperField(this, bosdyn_api_service_customization_pb.DictParam.Spec, 2));
};
 ...
 * @return {!proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse} returns this
*/
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse.prototype.setCustomParams = function(value) {
 ...
 * @return {!proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse} returns this
 */
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse.prototype.clearCustomParams = function() {
 ...
 * @return {boolean}
 */
proto.bosdyn.api.mission.GetRemoteMissionServiceInfoResponse.prototype.hasCustomParams = function() {
