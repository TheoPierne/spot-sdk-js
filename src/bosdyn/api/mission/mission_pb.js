...
goog.exportSymbol('proto.bosdyn.api.mission.AnswerQuestionRequest.AnswerCase', null, global);
...
goog.exportSymbol('proto.bosdyn.api.mission.State.AnsweredQuestion.AcceptedAnswerCase', null, global);
...
goog.exportSymbol('proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState', null, global);
...
proto.bosdyn.api.mission.State.AnsweredQuestion = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.bosdyn.api.mission.State.AnsweredQuestion.oneofGroups_);
};
 ...
 * @constructor
 */
proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState.repeatedFields_, null);
};
goog.inherits(proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState.displayName = 'proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.bosdyn.api.mission.AnswerQuestionRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.bosdyn.api.mission.AnswerQuestionRequest.oneofGroups_);
};
 ...
 * @const
 */
proto.bosdyn.api.mission.State.repeatedFields_ = [1,2,3,9];
...
proto.bosdyn.api.mission.State.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 7:
      ...
      break;
    case 9:
      var value = new bosdyn_api_mission_util_pb.MissionText;
      reader.readMessage(value,bosdyn_api_mission_util_pb.MissionText.deserializeBinaryFromReader);
      msg.addActiveMissionText(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.bosdyn.api.mission.State.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getActiveMissionTextList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      9,
      f,
      bosdyn_api_mission_util_pb.MissionText.serializeBinaryToWriter
    );
  }
};
 ...
 * @const
 */
proto.bosdyn.api.mission.State.AnsweredQuestion.oneofGroups_ = [[2,3]];

/**
 * @enum {number}
 */
proto.bosdyn.api.mission.State.AnsweredQuestion.AcceptedAnswerCase = {
...
/**
 * @return {proto.bosdyn.api.mission.State.AnsweredQuestion.AcceptedAnswerCase}
 */
proto.bosdyn.api.mission.State.AnsweredQuestion.prototype.getAcceptedAnswerCase = function() {
  return /** @type {proto.bosdyn.api.mission.State.AnsweredQuestion.AcceptedAnswerCase} */(jspb.Message.computeOneofCase(this, proto.bosdyn.api.mission.State.AnsweredQuestion.oneofGroups_[0]));
};
...
proto.bosdyn.api.mission.State.AnsweredQuestion.prototype.setAcceptedAnswerCode = function(value) {
  return jspb.Message.setOneofField(this, 2, proto.bosdyn.api.mission.State.AnsweredQuestion.oneofGroups_[0], value);
};
 ...
 * @return {!proto.bosdyn.api.mission.State.AnsweredQuestion} returns this
 */
proto.bosdyn.api.mission.State.AnsweredQuestion.prototype.clearAcceptedAnswerCode = function() {
  return jspb.Message.setOneofField(this, 2, proto.bosdyn.api.mission.State.AnsweredQuestion.oneofGroups_[0], undefined);
};
 ...
 * @return {boolean}
 */
proto.bosdyn.api.mission.State.AnsweredQuestion.prototype.hasAcceptedAnswerCode = function() {
  return jspb.Message.getField(this, 2) != null;
};


/**
 * optional bosdyn.api.DictParam custom_params = 3;
 * @return {?proto.bosdyn.api.DictParam}
 */
proto.bosdyn.api.mission.State.AnsweredQuestion.prototype.getCustomParams = function() {
  return /** @type{?proto.bosdyn.api.DictParam} */ (
    jspb.Message.getWrapperField(this, bosdyn_api_service_customization_pb.DictParam, 3));
};
 ...
 * @return {!proto.bosdyn.api.mission.State.AnsweredQuestion} returns this
*/
proto.bosdyn.api.mission.State.AnsweredQuestion.prototype.setCustomParams = function(value) {
  return jspb.Message.setOneofWrapperField(this, 3, proto.bosdyn.api.mission.State.AnsweredQuestion.oneofGroups_[0], value);
};
 ...
 * @return {!proto.bosdyn.api.mission.State.AnsweredQuestion} returns this
 */
proto.bosdyn.api.mission.State.AnsweredQuestion.prototype.clearCustomParams = function() {
 ...
 * @return {boolean}
 */
proto.bosdyn.api.mission.State.AnsweredQuestion.prototype.hasCustomParams = function() {
  return jspb.Message.getField(this, 3) != null;
};
...
proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 5:
      var value = new proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState;
      reader.readMessage(value,proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState.deserializeBinaryFromReader);
      msg.setBlackboard(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getBlackboard();
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState.serializeBinaryToWriter
    );
  }
};
 ...
 * @const
 */
proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState.prototype.toObject = function(opt_includeInstance) {
  return proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState;
  return proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState}
 */
proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState.prototype.getVariablesList = function() {
 ...
 * @return {!proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState} returns this
*/
proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState.prototype.setVariablesList = function(value) {
 ...
 */
proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState.prototype.addVariables = function(opt_value, opt_index) {
 ...
 * @return {!proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState} returns this
 */
proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState.prototype.clearVariablesList = function() {
...
/**
 * optional BlackboardState blackboard = 5;
 * @return {?proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState}
 */
proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.prototype.getBlackboard = function() {
  return /** @type{?proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState} */ (
    jspb.Message.getWrapperField(this, proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState, 5));
};


/**
 * @param {?proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.BlackboardState|undefined} value
 * @return {!proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState} returns this
*/
proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.prototype.setBlackboard = function(value) {
 ...
 * @return {!proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState} returns this
 */
proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.prototype.clearBlackboard = function() {
  return this.setBlackboard(undefined);
};
 ...
 * @return {boolean}
 */
proto.bosdyn.api.mission.State.NodeStatesAtTick.NodeState.prototype.hasBlackboard = function() {
 ...
 * @return {!Array<!proto.bosdyn.api.mission.MissionText>}
 */
proto.bosdyn.api.mission.State.prototype.getActiveMissionTextList = function() {
  return /** @type{!Array<!proto.bosdyn.api.mission.MissionText>} */ (
    jspb.Message.getRepeatedWrapperField(this, bosdyn_api_mission_util_pb.MissionText, 9));
};


/**
 * @param {!Array<!proto.bosdyn.api.mission.MissionText>} value
 * @return {!proto.bosdyn.api.mission.State} returns this
*/
proto.bosdyn.api.mission.State.prototype.setActiveMissionTextList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 9, value);
};


/**
 * @param {!proto.bosdyn.api.mission.MissionText=} opt_value
 * @param {number=} opt_index
 * @return {!proto.bosdyn.api.mission.MissionText}
 */
proto.bosdyn.api.mission.State.prototype.addActiveMissionText = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 9, opt_value, proto.bosdyn.api.mission.MissionText, opt_index);
};
 ...
 * @return {!proto.bosdyn.api.mission.State} returns this
 */
proto.bosdyn.api.mission.State.prototype.clearActiveMissionTextList = function() {
  return this.setActiveMissionTextList([]);
};
...
/**
 * optional bosdyn.api.DictParam.Spec custom_params = 7;
 * @return {?proto.bosdyn.api.DictParam.Spec}
 */
proto.bosdyn.api.mission.Question.prototype.getCustomParams = function() {
 ...
 * @return {!proto.bosdyn.api.mission.Question} returns this
*/
proto.bosdyn.api.mission.Question.prototype.setCustomParams = function(value) {
 ...
 * @return {!proto.bosdyn.api.mission.Question} returns this
 */
proto.bosdyn.api.mission.Question.prototype.clearCustomParams = function() {
  return this.setCustomParams(undefined);
};
 ...
 * @return {boolean}
 */
proto.bosdyn.api.mission.Question.prototype.hasCustomParams = function() {
 ...
 * @const
 */
proto.bosdyn.api.mission.AnswerQuestionRequest.oneofGroups_ = [[3,4]];

/**
 * @enum {number}
 */
proto.bosdyn.api.mission.AnswerQuestionRequest.AnswerCase = {
  ANSWER_NOT_SET: 0,
  CODE: 3,
  CUSTOM_PARAMS: 4
};
...
/**
 * @return {proto.bosdyn.api.mission.AnswerQuestionRequest.AnswerCase}
 */
proto.bosdyn.api.mission.AnswerQuestionRequest.prototype.getAnswerCase = function() {
  return /** @type {proto.bosdyn.api.mission.AnswerQuestionRequest.AnswerCase} */(jspb.Message.computeOneofCase(this, proto.bosdyn.api.mission.AnswerQuestionRequest.oneofGroups_[0]));
};
...
proto.bosdyn.api.mission.AnswerQuestionRequest.prototype.setCode = function(value) {
  return jspb.Message.setOneofField(this, 3, proto.bosdyn.api.mission.AnswerQuestionRequest.oneofGroups_[0], value);
};
 ...
 * @return {!proto.bosdyn.api.mission.AnswerQuestionRequest} returns this
 */
proto.bosdyn.api.mission.AnswerQuestionRequest.prototype.clearCode = function() {
  return jspb.Message.setOneofField(this, 3, proto.bosdyn.api.mission.AnswerQuestionRequest.oneofGroups_[0], undefined);
};
 ...
 * @return {boolean}
 */
proto.bosdyn.api.mission.AnswerQuestionRequest.prototype.hasCode = function() {
  return jspb.Message.getField(this, 3) != null;
};


/**
 * optional bosdyn.api.DictParam custom_params = 4;
 * @return {?proto.bosdyn.api.DictParam}
 */
proto.bosdyn.api.mission.AnswerQuestionRequest.prototype.getCustomParams = function() {
  return /** @type{?proto.bosdyn.api.DictParam} */ (
    jspb.Message.getWrapperField(this, bosdyn_api_service_customization_pb.DictParam, 4));
};
 ...
 * @return {!proto.bosdyn.api.mission.AnswerQuestionRequest} returns this
*/
proto.bosdyn.api.mission.AnswerQuestionRequest.prototype.setCustomParams = function(value) {
  return jspb.Message.setOneofWrapperField(this, 4, proto.bosdyn.api.mission.AnswerQuestionRequest.oneofGroups_[0], value);
};
 ...
 * @return {!proto.bosdyn.api.mission.AnswerQuestionRequest} returns this
 */
proto.bosdyn.api.mission.AnswerQuestionRequest.prototype.clearCustomParams = function() {
  return this.setCustomParams(undefined);
};
 ...
 * @return {boolean}
 */
proto.bosdyn.api.mission.AnswerQuestionRequest.prototype.hasCustomParams = function() {
  return jspb.Message.getField(this, 4) != null;
};
...
/**
 * optional bosdyn.api.CustomParamError custom_param_error = 3;
 * @return {?proto.bosdyn.api.CustomParamError}
 */
proto.bosdyn.api.mission.AnswerQuestionResponse.prototype.getCustomParamError = function() {
  return /** @type{?proto.bosdyn.api.CustomParamError} */ (
    jspb.Message.getWrapperField(this, bosdyn_api_service_customization_pb.CustomParamError, 3));
};
 ...
 * @return {!proto.bosdyn.api.mission.AnswerQuestionResponse} returns this
*/
proto.bosdyn.api.mission.AnswerQuestionResponse.prototype.setCustomParamError = function(value) {
 ...
 * @return {!proto.bosdyn.api.mission.AnswerQuestionResponse} returns this
 */
proto.bosdyn.api.mission.AnswerQuestionResponse.prototype.clearCustomParamError = function() {
 ...
 * @return {boolean}
 */
proto.bosdyn.api.mission.AnswerQuestionResponse.prototype.hasCustomParamError = function() {
  return jspb.Message.getField(this, 3) != null;
};
...
/**
 * optional bosdyn.api.graph_nav.TravelParams.PathPlannerMode planner_mode = 6;
 * @return {!proto.bosdyn.api.graph_nav.TravelParams.PathPlannerMode}
 */
proto.bosdyn.api.mission.PlaySettings.prototype.getPlannerMode = function() {
  return /** @type {!proto.bosdyn.api.graph_nav.TravelParams.PathPlannerMode} */ (jspb.Message.getFieldWithDefault(this, 6, 0));
};
 ...
 * @return {!proto.bosdyn.api.mission.PlaySettings} returns this
 */
proto.bosdyn.api.mission.PlaySettings.prototype.setPlannerMode = function(value) {
  return jspb.Message.setProto3EnumField(this, 6, value);
};
