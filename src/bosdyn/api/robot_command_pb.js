...
goog.exportSymbol('proto.bosdyn.api.JointControlStreamRequest', null, global);
goog.exportSymbol('proto.bosdyn.api.JointControlStreamResponse', null, global);
goog.exportSymbol('proto.bosdyn.api.JointControlStreamResponse.Status', null, global);
 ...
 * @constructor
 */
proto.bosdyn.api.JointControlStreamRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.bosdyn.api.JointControlStreamRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bosdyn.api.JointControlStreamRequest.displayName = 'proto.bosdyn.api.JointControlStreamRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.bosdyn.api.JointControlStreamResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.bosdyn.api.JointControlStreamResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bosdyn.api.JointControlStreamResponse.displayName = 'proto.bosdyn.api.JointControlStreamResponse';
}
 ...
 * @const
 */
proto.bosdyn.api.RobotCommand.oneofGroups_ = [[1,3]];
 ...
 * @const
 */
proto.bosdyn.api.RobotCommandFeedback.oneofGroups_ = [[2,3]];
 ...
 * @return {!Object}
 */
proto.bosdyn.api.JointControlStreamRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.bosdyn.api.JointControlStreamRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bosdyn.api.JointControlStreamRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.bosdyn.api.JointControlStreamRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bosdyn.api.JointControlStreamRequest;
  return proto.bosdyn.api.JointControlStreamRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bosdyn.api.JointControlStreamRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bosdyn.api.JointControlStreamRequest}
 */
proto.bosdyn.api.JointControlStreamRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new bosdyn_api_basic_command_pb.JointCommand.UpdateRequest;
      reader.readMessage(value,bosdyn_api_basic_command_pb.JointCommand.UpdateRequest.deserializeBinaryFromReader);
      msg.setJointCommand(value);
      break;
    case 3:
      var value = new bosdyn_api_basic_command_pb.JointCommand.ContactAdvice;
      reader.readMessage(value,bosdyn_api_basic_command_pb.JointCommand.ContactAdvice.deserializeBinaryFromReader);
      msg.setContactAdvice(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.bosdyn.api.JointControlStreamRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bosdyn.api.JointControlStreamRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bosdyn.api.JointControlStreamRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bosdyn.api.JointControlStreamRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getHeader();
  if (f != null) {
    writer.writeMessage(
  ...
  f = message.getJointCommand();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      bosdyn_api_basic_command_pb.JointCommand.UpdateRequest.serializeBinaryToWriter
    );
  }
  f = message.getContactAdvice();
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      bosdyn_api_basic_command_pb.JointCommand.ContactAdvice.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {?proto.bosdyn.api.RequestHeader}
 */
proto.bosdyn.api.JointControlStreamRequest.prototype.getHeader = function() {
  return /** @type{?proto.bosdyn.api.RequestHeader} */ (
    jspb.Message.getWrapperField(this, bosdyn_api_header_pb.RequestHeader, 1));
};
...
/**
 * @param {?proto.bosdyn.api.RequestHeader|undefined} value
 * @return {!proto.bosdyn.api.JointControlStreamRequest} returns this
*/
proto.bosdyn.api.JointControlStreamRequest.prototype.setHeader = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.bosdyn.api.JointControlStreamRequest} returns this
 */
proto.bosdyn.api.JointControlStreamRequest.prototype.clearHeader = function() {
  return this.setHeader(undefined);
};
 ...
 * @return {boolean}
 */
proto.bosdyn.api.JointControlStreamRequest.prototype.hasHeader = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional JointCommand.UpdateRequest joint_command = 2;
 * @return {?proto.bosdyn.api.JointCommand.UpdateRequest}
 */
proto.bosdyn.api.JointControlStreamRequest.prototype.getJointCommand = function() {
  return /** @type{?proto.bosdyn.api.JointCommand.UpdateRequest} */ (
    jspb.Message.getWrapperField(this, bosdyn_api_basic_command_pb.JointCommand.UpdateRequest, 2));
};


/**
 * @param {?proto.bosdyn.api.JointCommand.UpdateRequest|undefined} value
 * @return {!proto.bosdyn.api.JointControlStreamRequest} returns this
*/
proto.bosdyn.api.JointControlStreamRequest.prototype.setJointCommand = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.bosdyn.api.JointControlStreamRequest} returns this
 */
proto.bosdyn.api.JointControlStreamRequest.prototype.clearJointCommand = function() {
  return this.setJointCommand(undefined);
};
 ...
 * @return {boolean}
 */
proto.bosdyn.api.JointControlStreamRequest.prototype.hasJointCommand = function() {
  return jspb.Message.getField(this, 2) != null;
};


/**
 * optional JointCommand.ContactAdvice contact_advice = 3;
 * @return {?proto.bosdyn.api.JointCommand.ContactAdvice}
 */
proto.bosdyn.api.JointControlStreamRequest.prototype.getContactAdvice = function() {
  return /** @type{?proto.bosdyn.api.JointCommand.ContactAdvice} */ (
    jspb.Message.getWrapperField(this, bosdyn_api_basic_command_pb.JointCommand.ContactAdvice, 3));
};


/**
 * @param {?proto.bosdyn.api.JointCommand.ContactAdvice|undefined} value
 * @return {!proto.bosdyn.api.JointControlStreamRequest} returns this
*/
proto.bosdyn.api.JointControlStreamRequest.prototype.setContactAdvice = function(value) {
  return jspb.Message.setWrapperField(this, 3, value);
};
 ...
 * @return {!proto.bosdyn.api.JointControlStreamRequest} returns this
 */
proto.bosdyn.api.JointControlStreamRequest.prototype.clearContactAdvice = function() {
  return this.setContactAdvice(undefined);
};
 ...
 * @return {boolean}
 */
proto.bosdyn.api.JointControlStreamRequest.prototype.hasContactAdvice = function() {
  return jspb.Message.getField(this, 3) != null;
};
 ...
 * @return {!Object}
 */
proto.bosdyn.api.JointControlStreamResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.bosdyn.api.JointControlStreamResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bosdyn.api.JointControlStreamResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.bosdyn.api.JointControlStreamResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bosdyn.api.JointControlStreamResponse;
  return proto.bosdyn.api.JointControlStreamResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bosdyn.api.JointControlStreamResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bosdyn.api.JointControlStreamResponse}
 */
proto.bosdyn.api.JointControlStreamResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      break;
    case 2:
      var value = /** @type {!proto.bosdyn.api.JointControlStreamResponse.Status} */ (reader.readEnum());
      msg.setStatus(value);
      break;
    case 3:
      var value = /** @type {string} */ (reader.readString());
 ...
 * @return {!Uint8Array}
 */
proto.bosdyn.api.JointControlStreamResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bosdyn.api.JointControlStreamResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bosdyn.api.JointControlStreamResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bosdyn.api.JointControlStreamResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getHeader();
  if (f != null) {
    writer.writeMessage(
 ...
 * @enum {number}
 */
proto.bosdyn.api.JointControlStreamResponse.Status = {
  STATUS_UNKNOWN: 0,
  STATUS_OK: 1,
  STATUS_INVALID_REQUEST: 2,
  STATUS_INACTIVE: 3,
 ...
 * @return {?proto.bosdyn.api.ResponseHeader}
 */
proto.bosdyn.api.JointControlStreamResponse.prototype.getHeader = function() {
  return /** @type{?proto.bosdyn.api.ResponseHeader} */ (
    jspb.Message.getWrapperField(this, bosdyn_api_header_pb.ResponseHeader, 1));
};
...
/**
 * @param {?proto.bosdyn.api.ResponseHeader|undefined} value
 * @return {!proto.bosdyn.api.JointControlStreamResponse} returns this
*/
proto.bosdyn.api.JointControlStreamResponse.prototype.setHeader = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.bosdyn.api.JointControlStreamResponse} returns this
 */
proto.bosdyn.api.JointControlStreamResponse.prototype.clearHeader = function() {
  return this.setHeader(undefined);
};
 ...
 * @return {boolean}
 */
proto.bosdyn.api.JointControlStreamResponse.prototype.hasHeader = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!proto.bosdyn.api.JointControlStreamResponse.Status}
 */
proto.bosdyn.api.JointControlStreamResponse.prototype.getStatus = function() {
  return /** @type {!proto.bosdyn.api.JointControlStreamResponse.Status} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/**
 * @param {!proto.bosdyn.api.JointControlStreamResponse.Status} value
 * @return {!proto.bosdyn.api.JointControlStreamResponse} returns this
 */
proto.bosdyn.api.JointControlStreamResponse.prototype.setStatus = function(value) {
 ...
 * @return {string}
 */
proto.bosdyn.api.JointControlStreamResponse.prototype.getMessage = function() {
 ...
 * @return {!proto.bosdyn.api.JointControlStreamResponse} returns this
 */
proto.bosdyn.api.JointControlStreamResponse.prototype.setMessage = function(value) {
