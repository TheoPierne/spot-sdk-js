...
goog.exportSymbol('proto.bosdyn.api.docking.UpdateDockingParams', null, global);
/**
 ...
 * @constructor
 */
proto.bosdyn.api.docking.UpdateDockingParams = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.bosdyn.api.docking.UpdateDockingParams, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bosdyn.api.docking.UpdateDockingParams.displayName = 'proto.bosdyn.api.docking.UpdateDockingParams';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.bosdyn.api.docking.UpdateDockingParams.prototype.toObject = function(opt_includeInstance) {
  return proto.bosdyn.api.docking.UpdateDockingParams.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bosdyn.api.docking.UpdateDockingParams} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.bosdyn.api.docking.UpdateDockingParams.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bosdyn.api.docking.UpdateDockingParams;
  return proto.bosdyn.api.docking.UpdateDockingParams.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bosdyn.api.docking.UpdateDockingParams} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bosdyn.api.docking.UpdateDockingParams}
 */
proto.bosdyn.api.docking.UpdateDockingParams.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.bosdyn.api.docking.UpdateDockingParams.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bosdyn.api.docking.UpdateDockingParams.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bosdyn.api.docking.UpdateDockingParams} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bosdyn.api.docking.UpdateDockingParams.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getEndTime();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.google.protobuf.Timestamp}
 */
proto.bosdyn.api.docking.UpdateDockingParams.prototype.getEndTime = function() {
  return /** @type{?proto.google.protobuf.Timestamp} */ (
    jspb.Message.getWrapperField(this, google_protobuf_timestamp_pb.Timestamp, 5));
};
...
/**
 * @param {?proto.google.protobuf.Timestamp|undefined} value
 * @return {!proto.bosdyn.api.docking.UpdateDockingParams} returns this
*/
proto.bosdyn.api.docking.UpdateDockingParams.prototype.setEndTime = function(value) {
  return jspb.Message.setWrapperField(this, 5, value);
};
 ...
 * @return {!proto.bosdyn.api.docking.UpdateDockingParams} returns this
 */
proto.bosdyn.api.docking.UpdateDockingParams.prototype.clearEndTime = function() {
  return this.setEndTime(undefined);
};
 ...
 * @return {boolean}
 */
proto.bosdyn.api.docking.UpdateDockingParams.prototype.hasEndTime = function() {
  return jspb.Message.getField(this, 5) != null;
};
...
proto.bosdyn.api.docking.DockingCommandFeedbackRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.bosdyn.api.docking.UpdateDockingParams;
      reader.readMessage(value,proto.bosdyn.api.docking.UpdateDockingParams.deserializeBinaryFromReader);
      msg.setUpdateDockingParams(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.bosdyn.api.docking.DockingCommandFeedbackRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getUpdateDockingParams();
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.bosdyn.api.docking.UpdateDockingParams.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional UpdateDockingParams update_docking_params = 3;
 * @return {?proto.bosdyn.api.docking.UpdateDockingParams}
 */
proto.bosdyn.api.docking.DockingCommandFeedbackRequest.prototype.getUpdateDockingParams = function() {
  return /** @type{?proto.bosdyn.api.docking.UpdateDockingParams} */ (
    jspb.Message.getWrapperField(this, proto.bosdyn.api.docking.UpdateDockingParams, 3));
};


/**
 * @param {?proto.bosdyn.api.docking.UpdateDockingParams|undefined} value
 * @return {!proto.bosdyn.api.docking.DockingCommandFeedbackRequest} returns this
*/
proto.bosdyn.api.docking.DockingCommandFeedbackRequest.prototype.setUpdateDockingParams = function(value) {
 ...
 * @return {!proto.bosdyn.api.docking.DockingCommandFeedbackRequest} returns this
 */
proto.bosdyn.api.docking.DockingCommandFeedbackRequest.prototype.clearUpdateDockingParams = function() {
  return this.setUpdateDockingParams(undefined);
};
 ...
 * @return {boolean}
 */
proto.bosdyn.api.docking.DockingCommandFeedbackRequest.prototype.hasUpdateDockingParams = function() {
