...
goog.exportSymbol('proto.bosdyn.api.graph_nav.Edge.Annotations.StairData.DescentPreference', null, global);
...
goog.exportSymbol('proto.bosdyn.api.graph_nav.Region', null, global);
goog.exportSymbol('proto.bosdyn.api.graph_nav.Region.DataFilter', null, global);
goog.exportSymbol('proto.bosdyn.api.graph_nav.Region.ShapeCase', null, global);
goog.exportSymbol('proto.bosdyn.api.graph_nav.RegionWithFrame', null, global);
...
goog.exportSymbol('proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings', null, global);
...
proto.bosdyn.api.graph_nav.Waypoint.Annotations = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.bosdyn.api.graph_nav.Waypoint.Annotations.repeatedFields_, null);
};
 ...
 * @constructor
 */
proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings.displayName = 'proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.bosdyn.api.graph_nav.Region = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.bosdyn.api.graph_nav.Region.oneofGroups_);
};
goog.inherits(proto.bosdyn.api.graph_nav.Region, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bosdyn.api.graph_nav.Region.displayName = 'proto.bosdyn.api.graph_nav.Region';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.bosdyn.api.graph_nav.RegionWithFrame = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.bosdyn.api.graph_nav.RegionWithFrame, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bosdyn.api.graph_nav.RegionWithFrame.displayName = 'proto.bosdyn.api.graph_nav.RegionWithFrame';
}
 ...
 * @const
 */
proto.bosdyn.api.graph_nav.Waypoint.Annotations.repeatedFields_ = [9];
...
proto.bosdyn.api.graph_nav.Waypoint.Annotations.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 7:
      ...
      break;
    case 8:
      var value = new proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings;
      reader.readMessage(value,proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings.deserializeBinaryFromReader);
      msg.setGpsSettings(value);
      break;
    case 9:
      var value = new proto.bosdyn.api.graph_nav.RegionWithFrame;
      reader.readMessage(value,proto.bosdyn.api.graph_nav.RegionWithFrame.deserializeBinaryFromReader);
...
proto.bosdyn.api.graph_nav.Waypoint.Annotations.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      8,
      f,
      proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings.serializeBinaryToWriter
    );
  }
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      9,
      f,
      proto.bosdyn.api.graph_nav.RegionWithFrame.serializeBinaryToWriter
    );
  }
 ...
 * @return {!Object}
 */
proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings.prototype.toObject = function(opt_includeInstance) {
  return proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings;
  return proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings}
 */
proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      var value = new bosdyn_api_geometry_pb.SE3Pose;
      reader.readMessage(value,bosdyn_api_geometry_pb.SE3Pose.deserializeBinaryFromReader);
      msg.setEcefTformWaypoint(value);
      break;
    case 5:
      var value = /** @type {boolean} */ (reader.readBool());
      msg.setDisableGpsLocalization(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getState();
  if (f !== 0.0) {
    writer.writeEnum(
  ...
  f = message.getEcefTformWaypoint();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
  ...
  f = message.getDisableGpsLocalization();
  if (f) {
    writer.writeBool(
      5,
      f
 ...
 * @return {!proto.bosdyn.api.graph_nav.AnnotationState}
 */
proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings.prototype.getState = function() {
  return /** @type {!proto.bosdyn.api.graph_nav.AnnotationState} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {!proto.bosdyn.api.graph_nav.AnnotationState} value
 * @return {!proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings} returns this
 */
proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings.prototype.setState = function(value) {
  return jspb.Message.setProto3EnumField(this, 1, value);
};


/**
 * optional bosdyn.api.SE3Pose ecef_tform_waypoint = 2;
 * @return {?proto.bosdyn.api.SE3Pose}
 */
proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings.prototype.getEcefTformWaypoint = function() {
 ...
 * @return {!proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings} returns this
*/
proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings.prototype.setEcefTformWaypoint = function(value) {
 ...
 * @return {!proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings} returns this
 */
proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings.prototype.clearEcefTformWaypoint = function() {
  return this.setEcefTformWaypoint(undefined);
};
 ...
 * @return {boolean}
 */
proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings.prototype.hasEcefTformWaypoint = function() {
  return jspb.Message.getField(this, 2) != null;
};


/**
 * optional bool disable_gps_localization = 5;
 * @return {boolean}
 */
proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings.prototype.getDisableGpsLocalization = function() {
 ...
 * @return {!proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings} returns this
 */
proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings.prototype.setDisableGpsLocalization = function(value) {
...
/**
 * optional GPSSettings gps_settings = 8;
 * @return {?proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings}
 */
proto.bosdyn.api.graph_nav.Waypoint.Annotations.prototype.getGpsSettings = function() {
  return /** @type{?proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings} */ (
    jspb.Message.getWrapperField(this, proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings, 8));
};


/**
 * @param {?proto.bosdyn.api.graph_nav.Waypoint.Annotations.GPSSettings|undefined} value
 * @return {!proto.bosdyn.api.graph_nav.Waypoint.Annotations} returns this
*/
proto.bosdyn.api.graph_nav.Waypoint.Annotations.prototype.setGpsSettings = function(value) {
 ...
 * @return {!proto.bosdyn.api.graph_nav.Waypoint.Annotations} returns this
 */
proto.bosdyn.api.graph_nav.Waypoint.Annotations.prototype.clearGpsSettings = function() {
  return this.setGpsSettings(undefined);
};
 ...
 * @return {boolean}
 */
proto.bosdyn.api.graph_nav.Waypoint.Annotations.prototype.hasGpsSettings = function() {
 ...
 * @return {!Array<!proto.bosdyn.api.graph_nav.RegionWithFrame>}
 */
proto.bosdyn.api.graph_nav.Waypoint.Annotations.prototype.getRegionsList = function() {
  return /** @type{!Array<!proto.bosdyn.api.graph_nav.RegionWithFrame>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.bosdyn.api.graph_nav.RegionWithFrame, 9));
};


/**
 * @param {!Array<!proto.bosdyn.api.graph_nav.RegionWithFrame>} value
 * @return {!proto.bosdyn.api.graph_nav.Waypoint.Annotations} returns this
*/
proto.bosdyn.api.graph_nav.Waypoint.Annotations.prototype.setRegionsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 9, value);
};


/**
 * @param {!proto.bosdyn.api.graph_nav.RegionWithFrame=} opt_value
 * @param {number=} opt_index
 * @return {!proto.bosdyn.api.graph_nav.RegionWithFrame}
 */
proto.bosdyn.api.graph_nav.Waypoint.Annotations.prototype.addRegions = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 9, opt_value, proto.bosdyn.api.graph_nav.RegionWithFrame, opt_index);
};
 ...
 * @return {!proto.bosdyn.api.graph_nav.Waypoint.Annotations} returns this
 */
proto.bosdyn.api.graph_nav.Waypoint.Annotations.prototype.clearRegionsList = function() {
  return this.setRegionsList([]);
};


/**
 * optional LostDetectorStrictness lost_detector_strictness = 10;
 * @return {!proto.bosdyn.api.graph_nav.LostDetectorStrictness}
 */
proto.bosdyn.api.graph_nav.Waypoint.Annotations.prototype.getLostDetectorStrictness = function() {
  return /** @type {!proto.bosdyn.api.graph_nav.LostDetectorStrictness} */ (jspb.Message.getFieldWithDefault(this, 10, 0));
};
 ...
 * @return {!proto.bosdyn.api.graph_nav.Waypoint.Annotations} returns this
 */
proto.bosdyn.api.graph_nav.Waypoint.Annotations.prototype.setLostDetectorStrictness = function(value) {
...
proto.bosdyn.api.graph_nav.Edge.Annotations.StairData.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = /** @type {!proto.bosdyn.api.graph_nav.Edge.Annotations.StairData.DescentPreference} */ (reader.readEnum());
      msg.setDescentPreference(value);
      break;
    case 5:
      var value = new google_protobuf_wrappers_pb.DoubleValue;
      reader.readMessage(value,google_protobuf_wrappers_pb.DoubleValue.deserializeBinaryFromReader);
      msg.setTraversalYOffset(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.bosdyn.api.graph_nav.Edge.Annotations.StairData.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getDescentPreference();
  if (f !== 0.0) {
    writer.writeEnum(
      4,
      f
 ...
 * @enum {number}
 */
proto.bosdyn.api.graph_nav.Edge.Annotations.StairData.DescentPreference = {
...
/**
 * optional DescentPreference descent_preference = 4;
 * @return {!proto.bosdyn.api.graph_nav.Edge.Annotations.StairData.DescentPreference}
 */
proto.bosdyn.api.graph_nav.Edge.Annotations.StairData.prototype.getDescentPreference = function() {
  return /** @type {!proto.bosdyn.api.graph_nav.Edge.Annotations.StairData.DescentPreference} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};


/**
 * @param {!proto.bosdyn.api.graph_nav.Edge.Annotations.StairData.DescentPreference} value
 * @return {!proto.bosdyn.api.graph_nav.Edge.Annotations.StairData} returns this
 */
proto.bosdyn.api.graph_nav.Edge.Annotations.StairData.prototype.setDescentPreference = function(value) {
  return jspb.Message.setProto3EnumField(this, 4, value);
};


/**
 * optional google.protobuf.DoubleValue traversal_y_offset = 5;
 * @return {?proto.google.protobuf.DoubleValue}
 */
proto.bosdyn.api.graph_nav.Edge.Annotations.StairData.prototype.getTraversalYOffset = function() {
 ...
 * @return {!proto.bosdyn.api.graph_nav.Edge.Annotations.StairData} returns this
*/
proto.bosdyn.api.graph_nav.Edge.Annotations.StairData.prototype.setTraversalYOffset = function(value) {
  return jspb.Message.setWrapperField(this, 5, value);
};
 ...
 * @return {!proto.bosdyn.api.graph_nav.Edge.Annotations.StairData} returns this
 */
proto.bosdyn.api.graph_nav.Edge.Annotations.StairData.prototype.clearTraversalYOffset = function() {
  return this.setTraversalYOffset(undefined);
};
 ...
 * @return {boolean}
 */
proto.bosdyn.api.graph_nav.Edge.Annotations.StairData.prototype.hasTraversalYOffset = function() {
  return jspb.Message.getField(this, 5) != null;
};
 ...
 * @return {number}
 */
proto.bosdyn.api.graph_nav.Edge.Annotations.prototype.getMaxCorridorDistance = function() {
 ...
 * @return {!proto.bosdyn.api.graph_nav.Edge.Annotations} returns this
 */
proto.bosdyn.api.graph_nav.Edge.Annotations.prototype.setMaxCorridorDistance = function(value) {
 ...
 * @const
 */
proto.bosdyn.api.graph_nav.Region.oneofGroups_ = [[2]];

/**
 * @enum {number}
 */
proto.bosdyn.api.graph_nav.Region.ShapeCase = {
  SHAPE_NOT_SET: 0,
  BOUNDING_BOX: 2
};

/**
 * @return {proto.bosdyn.api.graph_nav.Region.ShapeCase}
 */
proto.bosdyn.api.graph_nav.Region.prototype.getShapeCase = function() {
  return /** @type {proto.bosdyn.api.graph_nav.Region.ShapeCase} */(jspb.Message.computeOneofCase(this, proto.bosdyn.api.graph_nav.Region.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.bosdyn.api.graph_nav.Region.prototype.toObject = function(opt_includeInstance) {
  return proto.bosdyn.api.graph_nav.Region.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bosdyn.api.graph_nav.Region} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.bosdyn.api.graph_nav.Region.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bosdyn.api.graph_nav.Region;
  return proto.bosdyn.api.graph_nav.Region.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bosdyn.api.graph_nav.Region} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bosdyn.api.graph_nav.Region}
 */
proto.bosdyn.api.graph_nav.Region.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new bosdyn_api_geometry_pb.Box3;
      reader.readMessage(value,bosdyn_api_geometry_pb.Box3.deserializeBinaryFromReader);
      msg.setBoundingBox(value);
      break;
    case 3:
      var value = /** @type {!proto.bosdyn.api.graph_nav.Region.DataFilter} */ (reader.readEnum());
 ...
 * @return {!Uint8Array}
 */
proto.bosdyn.api.graph_nav.Region.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bosdyn.api.graph_nav.Region.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bosdyn.api.graph_nav.Region} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bosdyn.api.graph_nav.Region.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      bosdyn_api_geometry_pb.Box3.serializeBinaryToWriter
    );
  }
  f = message.getDataFilter();
  if (f !== 0.0) {
    writer.writeEnum(
      3,
      f
 ...
 * @enum {number}
 */
proto.bosdyn.api.graph_nav.Region.DataFilter = {
 ...
 * @return {string}
 */
proto.bosdyn.api.graph_nav.Region.prototype.getRegionId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.bosdyn.api.graph_nav.Region} returns this
 */
proto.bosdyn.api.graph_nav.Region.prototype.setRegionId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional bosdyn.api.Box3 bounding_box = 2;
 * @return {?proto.bosdyn.api.Box3}
 */
proto.bosdyn.api.graph_nav.Region.prototype.getBoundingBox = function() {
  return /** @type{?proto.bosdyn.api.Box3} */ (
    jspb.Message.getWrapperField(this, bosdyn_api_geometry_pb.Box3, 2));
};
 ...
 * @return {!proto.bosdyn.api.graph_nav.Region} returns this
*/
proto.bosdyn.api.graph_nav.Region.prototype.setBoundingBox = function(value) {
  return jspb.Message.setOneofWrapperField(this, 2, proto.bosdyn.api.graph_nav.Region.oneofGroups_[0], value);
};
 ...
 * @return {!proto.bosdyn.api.graph_nav.Region} returns this
 */
proto.bosdyn.api.graph_nav.Region.prototype.clearBoundingBox = function() {
 ...
 * @return {boolean}
 */
proto.bosdyn.api.graph_nav.Region.prototype.hasBoundingBox = function() {
  return jspb.Message.getField(this, 2) != null;
};


/**
 * optional DataFilter data_filter = 3;
 * @return {!proto.bosdyn.api.graph_nav.Region.DataFilter}
 */
proto.bosdyn.api.graph_nav.Region.prototype.getDataFilter = function() {
  return /** @type {!proto.bosdyn.api.graph_nav.Region.DataFilter} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};


/**
 * @param {!proto.bosdyn.api.graph_nav.Region.DataFilter} value
 * @return {!proto.bosdyn.api.graph_nav.Region} returns this
 */
proto.bosdyn.api.graph_nav.Region.prototype.setDataFilter = function(value) {
 ...
 * @return {!Object}
 */
proto.bosdyn.api.graph_nav.RegionWithFrame.prototype.toObject = function(opt_includeInstance) {
  return proto.bosdyn.api.graph_nav.RegionWithFrame.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bosdyn.api.graph_nav.RegionWithFrame} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.bosdyn.api.graph_nav.RegionWithFrame.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bosdyn.api.graph_nav.RegionWithFrame;
  return proto.bosdyn.api.graph_nav.RegionWithFrame.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bosdyn.api.graph_nav.RegionWithFrame} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bosdyn.api.graph_nav.RegionWithFrame}
 */
proto.bosdyn.api.graph_nav.RegionWithFrame.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.bosdyn.api.graph_nav.Region;
      reader.readMessage(value,proto.bosdyn.api.graph_nav.Region.deserializeBinaryFromReader);
      msg.setRegion(value);
      break;
    case 2:
      var value = /** @type {string} */ (reader.readString());
    ...
    case 3:
      var value = new bosdyn_api_geometry_pb.SE3Pose;
      reader.readMessage(value,bosdyn_api_geometry_pb.SE3Pose.deserializeBinaryFromReader);
      msg.setBaseFrameTformRegion(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.bosdyn.api.graph_nav.RegionWithFrame.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bosdyn.api.graph_nav.RegionWithFrame.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bosdyn.api.graph_nav.RegionWithFrame} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bosdyn.api.graph_nav.RegionWithFrame.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getRegion();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.bosdyn.api.graph_nav.Region.serializeBinaryToWriter
    );
  }
  ...
  f = message.getBaseFrameTformRegion();
  if (f != null) {
    writer.writeMessage(
      3,
      f,
 ...
 * @return {?proto.bosdyn.api.graph_nav.Region}
 */
proto.bosdyn.api.graph_nav.RegionWithFrame.prototype.getRegion = function() {
  return /** @type{?proto.bosdyn.api.graph_nav.Region} */ (
    jspb.Message.getWrapperField(this, proto.bosdyn.api.graph_nav.Region, 1));
};


/**
 * @param {?proto.bosdyn.api.graph_nav.Region|undefined} value
 * @return {!proto.bosdyn.api.graph_nav.RegionWithFrame} returns this
*/
proto.bosdyn.api.graph_nav.RegionWithFrame.prototype.setRegion = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.bosdyn.api.graph_nav.RegionWithFrame} returns this
 */
proto.bosdyn.api.graph_nav.RegionWithFrame.prototype.clearRegion = function() {
 ...
 * @return {boolean}
 */
proto.bosdyn.api.graph_nav.RegionWithFrame.prototype.hasRegion = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional string base_frame_name = 2;
 * @return {string}
 */
proto.bosdyn.api.graph_nav.RegionWithFrame.prototype.getBaseFrameName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.bosdyn.api.graph_nav.RegionWithFrame} returns this
 */
proto.bosdyn.api.graph_nav.RegionWithFrame.prototype.setBaseFrameName = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};


/**
 * optional bosdyn.api.SE3Pose base_frame_tform_region = 3;
 * @return {?proto.bosdyn.api.SE3Pose}
 */
proto.bosdyn.api.graph_nav.RegionWithFrame.prototype.getBaseFrameTformRegion = function() {
  return /** @type{?proto.bosdyn.api.SE3Pose} */ (
    jspb.Message.getWrapperField(this, bosdyn_api_geometry_pb.SE3Pose, 3));
};
 ...
 * @return {!proto.bosdyn.api.graph_nav.RegionWithFrame} returns this
*/
proto.bosdyn.api.graph_nav.RegionWithFrame.prototype.setBaseFrameTformRegion = function(value) {
  return jspb.Message.setWrapperField(this, 3, value);
};
 ...
 * @return {!proto.bosdyn.api.graph_nav.RegionWithFrame} returns this
 */
proto.bosdyn.api.graph_nav.RegionWithFrame.prototype.clearBaseFrameTformRegion = function() {
  return this.setBaseFrameTformRegion(undefined);
};
 ...
 * @return {boolean}
 */
proto.bosdyn.api.graph_nav.RegionWithFrame.prototype.hasBaseFrameTformRegion = function() {
  return jspb.Message.getField(this, 3) != null;
};
