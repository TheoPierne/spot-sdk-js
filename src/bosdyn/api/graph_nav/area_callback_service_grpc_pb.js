...
function serialize_bosdyn_api_graph_nav_RouteChangeRequest(arg) {
  if (!(arg instanceof bosdyn_api_graph_nav_area_callback_pb.RouteChangeRequest)) {
    throw new Error('Expected argument of type bosdyn.api.graph_nav.RouteChangeRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_bosdyn_api_graph_nav_RouteChangeRequest(buffer_arg) {
  return bosdyn_api_graph_nav_area_callback_pb.RouteChangeRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_bosdyn_api_graph_nav_RouteChangeResponse(arg) {
  if (!(arg instanceof bosdyn_api_graph_nav_area_callback_pb.RouteChangeResponse)) {
    throw new Error('Expected argument of type bosdyn.api.graph_nav.RouteChangeResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_bosdyn_api_graph_nav_RouteChangeResponse(buffer_arg) {
  return bosdyn_api_graph_nav_area_callback_pb.RouteChangeResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
routeChange: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: bosdyn_api_graph_nav_area_callback_pb.RouteChangeRequest,
    responseType: bosdyn_api_graph_nav_area_callback_pb.RouteChangeResponse,
    requestSerialize: serialize_bosdyn_api_graph_nav_RouteChangeRequest,
    requestDeserialize: deserialize_bosdyn_api_graph_nav_RouteChangeRequest,
    responseSerialize: serialize_bosdyn_api_graph_nav_RouteChangeResponse,
    responseDeserialize: deserialize_bosdyn_api_graph_nav_RouteChangeResponse,
  },
...
exports.AreaCallbackServiceClient = grpc.makeGenericClientConstructor(AreaCallbackServiceService, 'AreaCallbackService');
