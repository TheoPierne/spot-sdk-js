...
goog.exportSymbol('proto.bosdyn.api.graph_nav.CompletedRoute', null, global);
goog.exportSymbol('proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge', null, global);
 ...
 * @constructor
 */
proto.bosdyn.api.graph_nav.CompletedRoute = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.bosdyn.api.graph_nav.CompletedRoute.repeatedFields_, null);
};
goog.inherits(proto.bosdyn.api.graph_nav.CompletedRoute, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bosdyn.api.graph_nav.CompletedRoute.displayName = 'proto.bosdyn.api.graph_nav.CompletedRoute';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge.displayName = 'proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.bosdyn.api.graph_nav.CompletedRoute.repeatedFields_ = [1,2];
 ...
 * @return {!Object}
 */
proto.bosdyn.api.graph_nav.CompletedRoute.prototype.toObject = function(opt_includeInstance) {
  return proto.bosdyn.api.graph_nav.CompletedRoute.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bosdyn.api.graph_nav.CompletedRoute} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.bosdyn.api.graph_nav.CompletedRoute.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bosdyn.api.graph_nav.CompletedRoute;
  return proto.bosdyn.api.graph_nav.CompletedRoute.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bosdyn.api.graph_nav.CompletedRoute} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bosdyn.api.graph_nav.CompletedRoute}
 */
proto.bosdyn.api.graph_nav.CompletedRoute.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge;
      reader.readMessage(value,proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge.deserializeBinaryFromReader);
      msg.addEdges(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.bosdyn.api.graph_nav.CompletedRoute.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bosdyn.api.graph_nav.CompletedRoute.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bosdyn.api.graph_nav.CompletedRoute} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bosdyn.api.graph_nav.CompletedRoute.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getWaypointIdsList();
  if (f.length > 0) {
    writer.writeRepeatedString(
      1,
      f
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge.prototype.toObject = function(opt_includeInstance) {
  return proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge;
  return proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge}
 */
proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getEdgeId();
  if (f != null) {
    writer.writeMessage(
...
/**
 * optional Edge.Id edge_id = 1;
 * @return {?proto.bosdyn.api.graph_nav.Edge.Id}
 */
proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge.prototype.getEdgeId = function() {
  return /** @type{?proto.bosdyn.api.graph_nav.Edge.Id} */ (
    jspb.Message.getWrapperField(this, bosdyn_api_graph_nav_map_pb.Edge.Id, 1));
};


/**
 * @param {?proto.bosdyn.api.graph_nav.Edge.Id|undefined} value
 * @return {!proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge} returns this
*/
proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge.prototype.setEdgeId = function(value) {
 ...
 * @return {!proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge} returns this
 */
proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge.prototype.clearEdgeId = function() {
 ...
 * @return {boolean}
 */
proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge.prototype.hasEdgeId = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional bool not_in_map = 2;
 * @return {boolean}
 */
proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge.prototype.getNotInMap = function() {
 ...
 * @return {!proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge} returns this
 */
proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge.prototype.setNotInMap = function(value) {
 ...
 * @return {!Array<string>}
 */
proto.bosdyn.api.graph_nav.CompletedRoute.prototype.getWaypointIdsList = function() {
...
/**
 * @param {!Array<string>} value
 * @return {!proto.bosdyn.api.graph_nav.CompletedRoute} returns this
 */
proto.bosdyn.api.graph_nav.CompletedRoute.prototype.setWaypointIdsList = function(value) {
 ...
 * @return {!proto.bosdyn.api.graph_nav.CompletedRoute} returns this
 */
proto.bosdyn.api.graph_nav.CompletedRoute.prototype.addWaypointIds = function(value, opt_index) {
 ...
 * @return {!proto.bosdyn.api.graph_nav.CompletedRoute} returns this
 */
proto.bosdyn.api.graph_nav.CompletedRoute.prototype.clearWaypointIdsList = function() {
  return this.setWaypointIdsList([]);
};


/**
 * repeated CompletedEdge edges = 2;
 * @return {!Array<!proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge>}
 */
proto.bosdyn.api.graph_nav.CompletedRoute.prototype.getEdgesList = function() {
  return /** @type{!Array<!proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge, 2));
};


/**
 * @param {!Array<!proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge>} value
 * @return {!proto.bosdyn.api.graph_nav.CompletedRoute} returns this
*/
proto.bosdyn.api.graph_nav.CompletedRoute.prototype.setEdgesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 2, value);
};


/**
 * @param {!proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge=} opt_value
 * @param {number=} opt_index
 * @return {!proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge}
 */
proto.bosdyn.api.graph_nav.CompletedRoute.prototype.addEdges = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.bosdyn.api.graph_nav.CompletedRoute.CompletedEdge, opt_index);
};
 ...
 * @return {!proto.bosdyn.api.graph_nav.CompletedRoute} returns this
 */
proto.bosdyn.api.graph_nav.CompletedRoute.prototype.clearEdgesList = function() {
