...
goog.exportSymbol('proto.bosdyn.api.CircleWithFrame', null, global);
...
goog.exportSymbol('proto.bosdyn.api.MatrixInt32', null, global);
goog.exportSymbol('proto.bosdyn.api.MatrixInt64', null, global);
goog.exportSymbol('proto.bosdyn.api.Matrixf', null, global);
goog.exportSymbol('proto.bosdyn.api.OrientedBox2', null, global);
...
goog.exportSymbol('proto.bosdyn.api.Vector', null, global);
 ...
 * @constructor
 */
proto.bosdyn.api.OrientedBox2 = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.bosdyn.api.OrientedBox2, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bosdyn.api.OrientedBox2.displayName = 'proto.bosdyn.api.OrientedBox2';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.bosdyn.api.Matrixf = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.bosdyn.api.Matrixf.repeatedFields_, null);
};
goog.inherits(proto.bosdyn.api.Matrixf, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bosdyn.api.Matrixf.displayName = 'proto.bosdyn.api.Matrixf';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.bosdyn.api.MatrixInt64 = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.bosdyn.api.MatrixInt64.repeatedFields_, null);
};
goog.inherits(proto.bosdyn.api.MatrixInt64, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bosdyn.api.MatrixInt64.displayName = 'proto.bosdyn.api.MatrixInt64';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.bosdyn.api.MatrixInt32 = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.bosdyn.api.MatrixInt32.repeatedFields_, null);
};
goog.inherits(proto.bosdyn.api.MatrixInt32, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bosdyn.api.MatrixInt32.displayName = 'proto.bosdyn.api.MatrixInt32';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.bosdyn.api.Vector = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.bosdyn.api.Vector.repeatedFields_, null);
};
goog.inherits(proto.bosdyn.api.Vector, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bosdyn.api.Vector.displayName = 'proto.bosdyn.api.Vector';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.bosdyn.api.CircleWithFrame = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.bosdyn.api.CircleWithFrame, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bosdyn.api.CircleWithFrame.displayName = 'proto.bosdyn.api.CircleWithFrame';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.bosdyn.api.OrientedBox2.prototype.toObject = function(opt_includeInstance) {
  return proto.bosdyn.api.OrientedBox2.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bosdyn.api.OrientedBox2} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.bosdyn.api.OrientedBox2.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bosdyn.api.OrientedBox2;
  return proto.bosdyn.api.OrientedBox2.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bosdyn.api.OrientedBox2} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bosdyn.api.OrientedBox2}
 */
proto.bosdyn.api.OrientedBox2.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.bosdyn.api.OrientedBox2.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bosdyn.api.OrientedBox2.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bosdyn.api.OrientedBox2} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bosdyn.api.OrientedBox2.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getBox();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.bosdyn.api.Box2}
 */
proto.bosdyn.api.OrientedBox2.prototype.getBox = function() {
 ...
 * @return {!proto.bosdyn.api.OrientedBox2} returns this
*/
proto.bosdyn.api.OrientedBox2.prototype.setBox = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.bosdyn.api.OrientedBox2} returns this
 */
proto.bosdyn.api.OrientedBox2.prototype.clearBox = function() {
 ...
 * @return {boolean}
 */
proto.bosdyn.api.OrientedBox2.prototype.hasBox = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {number}
 */
proto.bosdyn.api.OrientedBox2.prototype.getAngle = function() {
  return /** @type {number} */ (jspb.Message.getFloatingPointFieldWithDefault(this, 2, 0.0));
};
 ...
 * @return {!proto.bosdyn.api.OrientedBox2} returns this
 */
proto.bosdyn.api.OrientedBox2.prototype.setAngle = function(value) {
  return jspb.Message.setProto3FloatField(this, 2, value);
};
 ...
 * @const
 */
proto.bosdyn.api.Matrixf.repeatedFields_ = [3];
 ...
 * @return {!Object}
 */
proto.bosdyn.api.Matrixf.prototype.toObject = function(opt_includeInstance) {
  return proto.bosdyn.api.Matrixf.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bosdyn.api.Matrixf} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.bosdyn.api.Matrixf.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bosdyn.api.Matrixf;
  return proto.bosdyn.api.Matrixf.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bosdyn.api.Matrixf} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bosdyn.api.Matrixf}
 */
proto.bosdyn.api.Matrixf.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.bosdyn.api.Matrixf.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bosdyn.api.Matrixf.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bosdyn.api.Matrixf} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bosdyn.api.Matrixf.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getRows();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.bosdyn.api.Matrixf.prototype.getRows = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.bosdyn.api.Matrixf} returns this
 */
proto.bosdyn.api.Matrixf.prototype.setRows = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.bosdyn.api.Matrixf.prototype.getCols = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.bosdyn.api.Matrixf} returns this
 */
proto.bosdyn.api.Matrixf.prototype.setCols = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {!Array<number>}
 */
proto.bosdyn.api.Matrixf.prototype.getValuesList = function() {
  return /** @type {!Array<number>} */ (jspb.Message.getRepeatedFloatingPointField(this, 3));
};
 ...
 * @return {!proto.bosdyn.api.Matrixf} returns this
 */
proto.bosdyn.api.Matrixf.prototype.setValuesList = function(value) {
  return jspb.Message.setField(this, 3, value || []);
};
 ...
 * @return {!proto.bosdyn.api.Matrixf} returns this
 */
proto.bosdyn.api.Matrixf.prototype.addValues = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 3, value, opt_index);
};
 ...
 * @return {!proto.bosdyn.api.Matrixf} returns this
 */
proto.bosdyn.api.Matrixf.prototype.clearValuesList = function() {
  return this.setValuesList([]);
};
 ...
 * @const
 */
proto.bosdyn.api.MatrixInt64.repeatedFields_ = [3];
 ...
 * @return {!Object}
 */
proto.bosdyn.api.MatrixInt64.prototype.toObject = function(opt_includeInstance) {
  return proto.bosdyn.api.MatrixInt64.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bosdyn.api.MatrixInt64} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.bosdyn.api.MatrixInt64.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bosdyn.api.MatrixInt64;
  return proto.bosdyn.api.MatrixInt64.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bosdyn.api.MatrixInt64} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bosdyn.api.MatrixInt64}
 */
proto.bosdyn.api.MatrixInt64.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.bosdyn.api.MatrixInt64.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bosdyn.api.MatrixInt64.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bosdyn.api.MatrixInt64} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bosdyn.api.MatrixInt64.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getRows();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.bosdyn.api.MatrixInt64.prototype.getRows = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.bosdyn.api.MatrixInt64} returns this
 */
proto.bosdyn.api.MatrixInt64.prototype.setRows = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.bosdyn.api.MatrixInt64.prototype.getCols = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.bosdyn.api.MatrixInt64} returns this
 */
proto.bosdyn.api.MatrixInt64.prototype.setCols = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {!Array<number>}
 */
proto.bosdyn.api.MatrixInt64.prototype.getValuesList = function() {
 ...
 * @return {!proto.bosdyn.api.MatrixInt64} returns this
 */
proto.bosdyn.api.MatrixInt64.prototype.setValuesList = function(value) {
  return jspb.Message.setField(this, 3, value || []);
};
 ...
 * @return {!proto.bosdyn.api.MatrixInt64} returns this
 */
proto.bosdyn.api.MatrixInt64.prototype.addValues = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 3, value, opt_index);
};
 ...
 * @return {!proto.bosdyn.api.MatrixInt64} returns this
 */
proto.bosdyn.api.MatrixInt64.prototype.clearValuesList = function() {
  return this.setValuesList([]);
};
 ...
 * @const
 */
proto.bosdyn.api.MatrixInt32.repeatedFields_ = [3];
 ...
 * @return {!Object}
 */
proto.bosdyn.api.MatrixInt32.prototype.toObject = function(opt_includeInstance) {
  return proto.bosdyn.api.MatrixInt32.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bosdyn.api.MatrixInt32} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.bosdyn.api.MatrixInt32.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bosdyn.api.MatrixInt32;
  return proto.bosdyn.api.MatrixInt32.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bosdyn.api.MatrixInt32} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bosdyn.api.MatrixInt32}
 */
proto.bosdyn.api.MatrixInt32.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.bosdyn.api.MatrixInt32.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bosdyn.api.MatrixInt32.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bosdyn.api.MatrixInt32} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bosdyn.api.MatrixInt32.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getRows();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.bosdyn.api.MatrixInt32.prototype.getRows = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.bosdyn.api.MatrixInt32} returns this
 */
proto.bosdyn.api.MatrixInt32.prototype.setRows = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.bosdyn.api.MatrixInt32.prototype.getCols = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.bosdyn.api.MatrixInt32} returns this
 */
proto.bosdyn.api.MatrixInt32.prototype.setCols = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {!Array<number>}
 */
proto.bosdyn.api.MatrixInt32.prototype.getValuesList = function() {
  return /** @type {!Array<number>} */ (jspb.Message.getRepeatedField(this, 3));
};
 ...
 * @return {!proto.bosdyn.api.MatrixInt32} returns this
 */
proto.bosdyn.api.MatrixInt32.prototype.setValuesList = function(value) {
  return jspb.Message.setField(this, 3, value || []);
};
 ...
 * @return {!proto.bosdyn.api.MatrixInt32} returns this
 */
proto.bosdyn.api.MatrixInt32.prototype.addValues = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 3, value, opt_index);
};
 ...
 * @return {!proto.bosdyn.api.MatrixInt32} returns this
 */
proto.bosdyn.api.MatrixInt32.prototype.clearValuesList = function() {
  return this.setValuesList([]);
};
 ...
 * @const
 */
proto.bosdyn.api.Vector.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.bosdyn.api.Vector.prototype.toObject = function(opt_includeInstance) {
  return proto.bosdyn.api.Vector.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bosdyn.api.Vector} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.bosdyn.api.Vector.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bosdyn.api.Vector;
  return proto.bosdyn.api.Vector.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bosdyn.api.Vector} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bosdyn.api.Vector}
 */
proto.bosdyn.api.Vector.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.bosdyn.api.Vector.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bosdyn.api.Vector.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bosdyn.api.Vector} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bosdyn.api.Vector.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getValuesList();
  if (f.length > 0) {
    writer.writePackedDouble(
 ...
 * @return {!Array<number>}
 */
proto.bosdyn.api.Vector.prototype.getValuesList = function() {
...
/**
 * @param {!Array<number>} value
 * @return {!proto.bosdyn.api.Vector} returns this
 */
proto.bosdyn.api.Vector.prototype.setValuesList = function(value) {
 ...
 * @return {!proto.bosdyn.api.Vector} returns this
 */
proto.bosdyn.api.Vector.prototype.addValues = function(value, opt_index) {
 ...
 * @return {!proto.bosdyn.api.Vector} returns this
 */
proto.bosdyn.api.Vector.prototype.clearValuesList = function() {
  return this.setValuesList([]);
};
 ...
 * @return {!Object}
 */
proto.bosdyn.api.CircleWithFrame.prototype.toObject = function(opt_includeInstance) {
  return proto.bosdyn.api.CircleWithFrame.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bosdyn.api.CircleWithFrame} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.bosdyn.api.CircleWithFrame.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bosdyn.api.CircleWithFrame;
  return proto.bosdyn.api.CircleWithFrame.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bosdyn.api.CircleWithFrame} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bosdyn.api.CircleWithFrame}
 */
proto.bosdyn.api.CircleWithFrame.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 3:
      var value = new proto.bosdyn.api.SE3Pose;
      reader.readMessage(value,proto.bosdyn.api.SE3Pose.deserializeBinaryFromReader);
      msg.setFrameNameTformCircle(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.bosdyn.api.CircleWithFrame.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bosdyn.api.CircleWithFrame.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bosdyn.api.CircleWithFrame} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bosdyn.api.CircleWithFrame.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getCircle();
  if (f != null) {
    writer.writeMessage(
  ...
  f = message.getFrameNameTformCircle();
  if (f != null) {
    writer.writeMessage(
      3,
      f,
 ...
 * @return {?proto.bosdyn.api.Circle}
 */
proto.bosdyn.api.CircleWithFrame.prototype.getCircle = function() {
  return /** @type{?proto.bosdyn.api.Circle} */ (
    jspb.Message.getWrapperField(this, proto.bosdyn.api.Circle, 1));
};


/**
 * @param {?proto.bosdyn.api.Circle|undefined} value
 * @return {!proto.bosdyn.api.CircleWithFrame} returns this
*/
proto.bosdyn.api.CircleWithFrame.prototype.setCircle = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.bosdyn.api.CircleWithFrame} returns this
 */
proto.bosdyn.api.CircleWithFrame.prototype.clearCircle = function() {
 ...
 * @return {boolean}
 */
proto.bosdyn.api.CircleWithFrame.prototype.hasCircle = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {string}
 */
proto.bosdyn.api.CircleWithFrame.prototype.getFrameName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.bosdyn.api.CircleWithFrame} returns this
 */
proto.bosdyn.api.CircleWithFrame.prototype.setFrameName = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {?proto.bosdyn.api.SE3Pose}
 */
proto.bosdyn.api.CircleWithFrame.prototype.getFrameNameTformCircle = function() {
  return /** @type{?proto.bosdyn.api.SE3Pose} */ (
    jspb.Message.getWrapperField(this, proto.bosdyn.api.SE3Pose, 3));
};
 ...
 * @return {!proto.bosdyn.api.CircleWithFrame} returns this
*/
proto.bosdyn.api.CircleWithFrame.prototype.setFrameNameTformCircle = function(value) {
  return jspb.Message.setWrapperField(this, 3, value);
};
 ...
 * @return {!proto.bosdyn.api.CircleWithFrame} returns this
 */
proto.bosdyn.api.CircleWithFrame.prototype.clearFrameNameTformCircle = function() {
  return this.setFrameNameTformCircle(undefined);
};
 ...
 * @return {boolean}
 */
proto.bosdyn.api.CircleWithFrame.prototype.hasFrameNameTformCircle = function() {
  return jspb.Message.getField(this, 3) != null;
};
