...
function serialize_bosdyn_api_ResetSafetyStopRequest(arg) {
  if (!(arg instanceof bosdyn_api_power_pb.ResetSafetyStopRequest)) {
    throw new Error('Expected argument of type bosdyn.api.ResetSafetyStopRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_bosdyn_api_ResetSafetyStopRequest(buffer_arg) {
  return bosdyn_api_power_pb.ResetSafetyStopRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_bosdyn_api_ResetSafetyStopResponse(arg) {
  if (!(arg instanceof bosdyn_api_power_pb.ResetSafetyStopResponse)) {
    throw new Error('Expected argument of type bosdyn.api.ResetSafetyStopResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_bosdyn_api_ResetSafetyStopResponse(buffer_arg) {
  return bosdyn_api_power_pb.ResetSafetyStopResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
resetSafetyStop: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: bosdyn_api_power_pb.ResetSafetyStopRequest,
    responseType: bosdyn_api_power_pb.ResetSafetyStopResponse,
    requestSerialize: serialize_bosdyn_api_ResetSafetyStopRequest,
    requestDeserialize: deserialize_bosdyn_api_ResetSafetyStopRequest,
    responseSerialize: serialize_bosdyn_api_ResetSafetyStopResponse,
    responseDeserialize: deserialize_bosdyn_api_ResetSafetyStopResponse,
  },
};

exports.PowerServiceClient = grpc.makeGenericClientConstructor(PowerServiceService, 'PowerService');
