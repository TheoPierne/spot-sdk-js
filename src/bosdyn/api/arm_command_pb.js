...
proto.bosdyn.api.ArmCartesianCommand.Request.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 21:
      var value = new google_protobuf_wrappers_pb.BoolValue;
      reader.readMessage(value,google_protobuf_wrappers_pb.BoolValue.deserializeBinaryFromReader);
      msg.setDisableVelocityLimiting(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.bosdyn.api.ArmCartesianCommand.Request.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getDisableVelocityLimiting();
  if (f != null) {
    writer.writeMessage(
      21,
      f,
...
/**
 * optional google.protobuf.BoolValue disable_velocity_limiting = 21;
 * @return {?proto.google.protobuf.BoolValue}
 */
proto.bosdyn.api.ArmCartesianCommand.Request.prototype.getDisableVelocityLimiting = function() {
  return /** @type{?proto.google.protobuf.BoolValue} */ (
 ...
 * @return {!proto.bosdyn.api.ArmCartesianCommand.Request} returns this
*/
proto.bosdyn.api.ArmCartesianCommand.Request.prototype.setDisableVelocityLimiting = function(value) {
 ...
 * @return {!proto.bosdyn.api.ArmCartesianCommand.Request} returns this
 */
proto.bosdyn.api.ArmCartesianCommand.Request.prototype.clearDisableVelocityLimiting = function() {
  return this.setDisableVelocityLimiting(undefined);
};
 ...
 * @return {boolean}
 */
proto.bosdyn.api.ArmCartesianCommand.Request.prototype.hasDisableVelocityLimiting = function() {
...
proto.bosdyn.api.ArmImpedanceCommand.Request.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 10:
      var value = new google_protobuf_wrappers_pb.BoolValue;
      reader.readMessage(value,google_protobuf_wrappers_pb.BoolValue.deserializeBinaryFromReader);
      msg.setDisableSafetyCheck(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.bosdyn.api.ArmImpedanceCommand.Request.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getDisableSafetyCheck();
  if (f != null) {
    writer.writeMessage(
      10,
      f,
...
/**
 * optional google.protobuf.BoolValue disable_safety_check = 10;
 * @return {?proto.google.protobuf.BoolValue}
 */
proto.bosdyn.api.ArmImpedanceCommand.Request.prototype.getDisableSafetyCheck = function() {
  return /** @type{?proto.google.protobuf.BoolValue} */ (
 ...
 * @return {!proto.bosdyn.api.ArmImpedanceCommand.Request} returns this
*/
proto.bosdyn.api.ArmImpedanceCommand.Request.prototype.setDisableSafetyCheck = function(value) {
  return jspb.Message.setWrapperField(this, 10, value);
};
 ...
 * @return {!proto.bosdyn.api.ArmImpedanceCommand.Request} returns this
 */
proto.bosdyn.api.ArmImpedanceCommand.Request.prototype.clearDisableSafetyCheck = function() {
  return this.setDisableSafetyCheck(undefined);
};
 ...
 * @return {boolean}
 */
proto.bosdyn.api.ArmImpedanceCommand.Request.prototype.hasDisableSafetyCheck = function() {
  return jspb.Message.getField(this, 10) != null;
};
