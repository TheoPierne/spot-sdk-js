...
class ProtobufChannelReader {
  constructor(protobuf_reader, protobuf_type, channel_name = null, base){
  ...
  get_message(index_in_series){
    const [_desc, timestamp, msg] = this._protobuf_reader.get_message(this._series_index, this._protobuf_type, index_in_series);
