...
class ProtobufSeriesWriter {
  constructor(data_writer, protobuf_type, channel_name = null, is_metadata = false, annotations = null, additional_index_names = null){
    ...
    this._series_index = this._data_writer.add_message_series(this.series_type, this.series_spec, PROTOBUF_CONTENT_TYPE, this._type_name, is_metadata, annotations, additional_index_names);
  }
