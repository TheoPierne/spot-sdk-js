...
goog.exportSymbol('proto.bosdyn.api.ServiceEntry.ServiceTypeCase', null, global);
/**
...
proto.bosdyn.api.ServiceEntry = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.bosdyn.api.ServiceEntry.oneofGroups_);
};
 ...
 * @const
 */
proto.bosdyn.api.ServiceEntry.oneofGroups_ = [[2]];

/**
 * @enum {number}
 */
proto.bosdyn.api.ServiceEntry.ServiceTypeCase = {
  SERVICE_TYPE_NOT_SET: 0,
  TYPE: 2
};

/**
 * @return {proto.bosdyn.api.ServiceEntry.ServiceTypeCase}
 */
proto.bosdyn.api.ServiceEntry.prototype.getServiceTypeCase = function() {
  return /** @type {proto.bosdyn.api.ServiceEntry.ServiceTypeCase} */(jspb.Message.computeOneofCase(this, proto.bosdyn.api.ServiceEntry.oneofGroups_[0]));
};
...
proto.bosdyn.api.ServiceEntry.prototype.setType = function(value) {
  return jspb.Message.setOneofField(this, 2, proto.bosdyn.api.ServiceEntry.oneofGroups_[0], value);
};
 ...
 * @return {!proto.bosdyn.api.ServiceEntry} returns this
 */
proto.bosdyn.api.ServiceEntry.prototype.clearType = function() {
  return jspb.Message.setOneofField(this, 2, proto.bosdyn.api.ServiceEntry.oneofGroups_[0], undefined);
};
 ...
 * @return {boolean}
 */
proto.bosdyn.api.ServiceEntry.prototype.hasType = function() {
