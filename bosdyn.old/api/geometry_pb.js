...
goog.exportSymbol('proto.bosdyn.api.EulerZXYRate', null, global);
 ...
 * @constructor
 */
proto.bosdyn.api.EulerZXYRate = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.bosdyn.api.EulerZXYRate, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bosdyn.api.EulerZXYRate.displayName = 'proto.bosdyn.api.EulerZXYRate';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.bosdyn.api.EulerZXYRate.prototype.toObject = function(opt_includeInstance) {
  return proto.bosdyn.api.EulerZXYRate.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bosdyn.api.EulerZXYRate} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bosdyn.api.EulerZXYRate.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.bosdyn.api.EulerZXYRate}
 */
proto.bosdyn.api.EulerZXYRate.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bosdyn.api.EulerZXYRate;
  return proto.bosdyn.api.EulerZXYRate.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bosdyn.api.EulerZXYRate} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bosdyn.api.EulerZXYRate}
 */
proto.bosdyn.api.EulerZXYRate.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.bosdyn.api.EulerZXYRate.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bosdyn.api.EulerZXYRate.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bosdyn.api.EulerZXYRate} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bosdyn.api.EulerZXYRate.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getYaw();
  if (f !== 0.0) {
    writer.writeDouble(
 ...
 * @return {number}
 */
proto.bosdyn.api.EulerZXYRate.prototype.getYaw = function() {
  return /** @type {number} */ (jspb.Message.getFloatingPointFieldWithDefault(this, 1, 0.0));
};
...
/**
 * @param {number} value
 * @return {!proto.bosdyn.api.EulerZXYRate} returns this
 */
proto.bosdyn.api.EulerZXYRate.prototype.setYaw = function(value) {
  return jspb.Message.setProto3FloatField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.bosdyn.api.EulerZXYRate.prototype.getRoll = function() {
  return /** @type {number} */ (jspb.Message.getFloatingPointFieldWithDefault(this, 2, 0.0));
};
 ...
 * @return {!proto.bosdyn.api.EulerZXYRate} returns this
 */
proto.bosdyn.api.EulerZXYRate.prototype.setRoll = function(value) {
  return jspb.Message.setProto3FloatField(this, 2, value);
};
 ...
 * @return {number}
 */
proto.bosdyn.api.EulerZXYRate.prototype.getPitch = function() {
  return /** @type {number} */ (jspb.Message.getFloatingPointFieldWithDefault(this, 3, 0.0));
};
 ...
 * @return {!proto.bosdyn.api.EulerZXYRate} returns this
 */
proto.bosdyn.api.EulerZXYRate.prototype.setPitch = function(value) {
  return jspb.Message.setProto3FloatField(this, 3, value);
};
