...
goog.exportSymbol('proto.bosdyn.api.GetPointCloudResponse.Status', null, global);
...
proto.bosdyn.api.GetPointCloudResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = /** @type {!proto.bosdyn.api.GetPointCloudResponse.Status} */ (reader.readEnum());
      msg.setStatus(value);
      break;
    case 3:
 ...
 * @enum {number}
 */
proto.bosdyn.api.GetPointCloudResponse.Status = {
  STATUS_UNKNOWN: 0,
  STATUS_OK: 1,
 ...
 * @return {!proto.bosdyn.api.GetPointCloudResponse.Status}
 */
proto.bosdyn.api.GetPointCloudResponse.prototype.getStatus = function() {
  return /** @type {!proto.bosdyn.api.GetPointCloudResponse.Status} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/**
 * @param {!proto.bosdyn.api.GetPointCloudResponse.Status} value
 * @return {!proto.bosdyn.api.GetPointCloudResponse} returns this
 */
proto.bosdyn.api.GetPointCloudResponse.prototype.setStatus = function(value) {
  return jspb.Message.setProto3EnumField(this, 2, value);
};


/**
 * optional PointCloud point_cloud = 3;
 * @return {?proto.bosdyn.api.PointCloud}
 */
proto.bosdyn.api.GetPointCloudResponse.prototype.getPointCloud = function() {
  return /** @type{?proto.bosdyn.api.PointCloud} */ (
    jspb.Message.getWrapperField(this, proto.bosdyn.api.PointCloud, 3));
};
 ...
 * @return {!proto.bosdyn.api.GetPointCloudResponse} returns this
*/
proto.bosdyn.api.GetPointCloudResponse.prototype.setPointCloud = function(value) {
 ...
 * @return {!proto.bosdyn.api.GetPointCloudResponse} returns this
 */
proto.bosdyn.api.GetPointCloudResponse.prototype.clearPointCloud = function() {
 ...
 * @return {boolean}
 */
proto.bosdyn.api.GetPointCloudResponse.prototype.hasPointCloud = function() {
